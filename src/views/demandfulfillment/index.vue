<template>
  ...
  <a-tabs type="card" v-model:activeKey="activeKey" tab-position="top">
    <a-tab-pane key="1" tab="Target WIP & Priority Quadrant">
      <TargetWipPriority></TargetWipPriority>
    </a-tab-pane>
    <a-tab-pane key="2" tab="Target Move">
      <TargetMove></TargetMove>
    </a-tab-pane>
    <a-tab-pane key="3" tab="Machine Loading for Target Move">
      <MachineLoadingForTargetMove></MachineLoadingForTargetMove>
    </a-tab-pane>
    <a-tab-pane key="4" tab="Forecast Move Forward">
      <ForecastMoveForward></ForecastMoveForward>
    </a-tab-pane>
    <a-tab-pane key="5" tab="Forecast Machine Loading Forward">
      <ForecastMachineLoadingForward></ForecastMachineLoadingForward>
    </a-tab-pane>
    <a-tab-pane key="6" tab="Forecast Output Forward">
      <ForecastOutputForward></ForecastOutputForward>
    </a-tab-pane>
  </a-tabs>
</template>
...
import TargetWipPriority from "./TargetWipPriority.vue";
import TargetMove from "./TargetMove.vue";
import ForecastMoveForward from "./ForecastMoveForward.vue";
import MachineLoadingForTargetMove from "./MachineLoadingForTargetMove.vue";
import ForecastMachineLoadingForward from "./ForecastMachineLoadingForward.vue";
import ForecastOutputForward from "./ForecastOutputForward.vue";
const fcstdata = [
  {
    key: 1,
...
export default defineComponent({
  ...
  components: {
    ...
    TargetMove,
    ForecastMoveForward,
    MachineLoadingForTargetMove,
    ForecastMachineLoadingForward,
    ForecastOutputForward
  },
  setup() {
    const status = ref(0);
